...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `user` (fname, lname, user_login, password, email, `role`) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($insertSQL, $achizitii) or die(mysql_error());

  $insertGoTo = "index_users.php";
  if (isset($_SERVER['QUERY_STRING'])) {
